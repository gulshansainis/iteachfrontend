...
const createCategoryPages = (createPage, edges) => {
  ...
  Object.keys(posts).forEach(category => {
    createPaginatedPages(createPage, posts[category], `/learn/${category}`, {
      categories,
...
const createBlog = (createPage, edges) => {
  ...
  createPaginatedPages(createPage, edges, "/articles", { categories })
}
...
exports.createPages = ({ actions, graphql }) =>
  ...
  `).then(({ data, errors }) => {
    ...
    createPosts(actions.createPage, actions.createRedirect, edges)
